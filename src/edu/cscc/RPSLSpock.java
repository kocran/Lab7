...
public class RPSLSpock {
    ...
    /**
     * validating that a valid answer choice has been inputted
     * date: 2/25/20
     * @param pick - inputted answer
     * @return bool: whether the inputted answer being valid is true or not
     */
    ...
    /**
     * method for generating the computer's random choice
     * @return the computer's pick: pick
     */
    ...
    /**
     * determines whether or the computer won
     * @param c_pick - computer pick
     * @param h_pick - valid human pick
     * @return bool: whether the computer won or not
     */
